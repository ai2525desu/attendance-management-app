...
Route::middleware('auth:admin')->group(function () {
    ...
    Route::get('/stamp_correction_request/approve/{attendance_correct_request_id}', [AttendanceCorrectionController::class, 'showApproval'])->name('admin.stamp_correction_request.approval');
    Route::post('/stamp_correction_request/approve/{attendance_correct_request_id}', [AttendanceCorrectionController::class, 'storeApproval'])->name('admin.stamp_correction_request.store_approval');
});
